fn main() {
    ...
    match cipher_rs::detection::autodetect(&buffer) {
        ...
        cipher_rs::CipherType::Polyalphabetic => println!("Likely a polyalphabetic cipher (eg. Vigenere)."),
        cipher_rs::CipherType::Transposition => println!("Likely a transposition cipher (eg. column transposition).")
